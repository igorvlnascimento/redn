...
sys.path.insert(0, "/home/igor/code/mestrado/REDN/opennre/model")
sys.path.insert(0, "/home/igor/code/mestrado/REDN/opennre/encoder")

from opennre import encoder, model, framework
from opennre.encoder.bert_encoder import BERTHiddenStateEncoder
...
from opennre.model.para import PARA
from opennre.framework.sentence_re import SentenceRE
import os


def train(dataset_name, batch_size=8, num_workers=0, max_epoch=15, lr=3e-5, weight_decay=1e-5, add_subject_loss=False,
